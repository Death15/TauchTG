...
local function run(msg, matches)
  if matches[1]:lower() == 'tauchtg' then -- Put everything you like :)
  ...
  if matches[1]:lower() == "stats" then
    ...
    if matches[2] == "TauchTG" then -- Put everything you like :)
      if not is_sudo(msg) then
        return "For ArashTauch only !"
      else
        return bot_stats()
      end
    end
...
return {
  patterns = {
    ...
    "^[!/]([Ss]tatslist)$",
    "^[!/]([Ss]tats) (group) (%d+)",
    "^[!/]([Ss]tats) (TauchTG)",-- Put everything you like :)
		"^[!/]([Tt]auch[Tt][Gg])"-- Put everything you like :)
    }, 
  run = run
}
